...
function populatePokemonList() {
    ...
    let recordProto = list.querySelector(".pokemon-record-proto");
    ...
    for (let i = 0; i < pokemons.length; ++i) {
        ...
        let nameHTML = newRecord.querySelector(".pokemon-name");
        let heightHTML = newRecord.querySelector(".pokemon-height");
        let weightHTML = newRecord.querySelector(".pokemon-weight");
        ...
        newRecord.querySelector(".pokemon-dangerous")
            .textContent = "NIE";
